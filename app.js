...
function populateTeacherSelectors() {
  const currentStudent = el("assignStudent").value;
  ...
  if (teacherStudents.some((s) => s.id === currentStudent)) el("assignStudent").value = currentStudent;
  ...
  if (!el("assignTopic").options.length) syncAssignmentCatalog();
}
